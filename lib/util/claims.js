...
function getEthereumPayload(dest, statement, options) {
    const decorated = metadata_1.createDecorated(options.registry, options.metadataRpc);
    const prefix = util_1.u8aToString(decorated.consts.claims.prefix.toU8a(true));
